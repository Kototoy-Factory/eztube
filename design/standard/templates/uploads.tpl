...
<div class="border-ml"><div class="border-mr"><div class="border-mc float-break">
	...
	<div class="content-view-full">
		<div class="eztube uploads">

		{if $video_list}
			<div class="attribute-header">
			    <h1>{'%1\'s Videos (%2)'|i18n( 'fumaggo/design/eztube/uploads',,array( $user_info.id|wash, $video_count ) )}</h1>
			</div>
		...
		{include name=navigator
			...
			page_uri=concat( "eztube/uploads/", $user_info.id|wash )
