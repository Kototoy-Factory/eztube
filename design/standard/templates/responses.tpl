...
<div class="border-ml"><div class="border-mr"><div class="border-mc float-break">
	...
	<div class="content-view-full">
		<div class="eztube responses">

		{if $video_list}
			<div class="attribute-header">
			    <h1>{'Video responses to "%1"'|i18n( 'fumaggo/design/eztube/responses',,array( $video.title|wash ) )}</h1>
			</div>
			...
			<div class="attribute-long">
				{foreach $video_list as $video_item}
					{include uri="design:content/youtubevideo.tpl" video=$video_item}
				{/foreach}
			</div>
		{else}
			 <div class="attribute-header">
		...
		{include name=navigator
			...
			page_uri=concat("eztube/responses/",$video.id|wash )
